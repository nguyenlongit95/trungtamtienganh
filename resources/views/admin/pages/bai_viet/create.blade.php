                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body" style="display: block;">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control" placeholder="Tiêu đề bài viết">
                                </div>
                                <div class="form-group">
                                    <label for="info">Thông tin giới thiệu</label> <span class="text-danger">*</span>
                                    <textarea name="info" class="form-control" id="info" cols="30" rows="3"></textarea>
                                </div>
                                <div class="form-group">
