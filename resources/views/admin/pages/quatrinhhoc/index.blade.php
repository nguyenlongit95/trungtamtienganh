    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Quản lý quá trình học của học viên</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <form action="{{ url('/admin/qua-trinh-hoc/search-hoc-vien') }}" method="post" enctype="multipart/form-data">
                                ...
                                @if(!empty($hocVien))
                                    @foreach($hocVien as $hv)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-primary" href="{{ url('/admin/qua-trinh-hoc/' . $hv->id . '/show') }}" title="Chỉnh sửa {{ $hv->name }}">Xem quá trình</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
