                    ...
                    <div class="col-8 float-left">
                        <div class="card card-primary">
                            ...
                            <div class="card-footer">
                                ...
                                <p>- Hình ảnh avatar sẽ được hiển thị lên website phía người dùng.</p>
                                ...
                                <p>- Khi không muốn hiển thị giảng viên nữa thì sẽ chọn không hiển thị.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="truong_dai_hoc" id="truong-dai-hoc" cols="30" rows="3">{{ $giangVien->truong_dai_hoc }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset('/avatars/' . $giangVien->avatar ) }}" height="120px" width="120px" alt="">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="hien_thi" id="hien_thi" class="form-control">
                                        <option value="1" @if($giangVien->hien_thi === 1) selected @endif>Hiển thị</option>
                                        <option value="0" @if($giangVien->hien_thi === 0 || $giangVien->hien_thi === null) selected @endif>Không hiển thị</option>
                                    </select>
                                </div>
                            </div>
                            <!-- /.card-body -->
