    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Chỉnh sửa nhận xét</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
        ...
        <section class="content">
            <div class="col-12 float-left">
                <form action="{{ url('/admin/says/update/' . $say->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body" style="display: block;">
                            <div class="form-group">
                                ...
                                <input type="text" id="ten" name="ten" class="form-control" value="{{ $say->ten }}">
                            </div>
                            <div class="form-group">
                                <label for="lop">Tên lớp theo học</label> <span class="text-danger">*</span>
                                <input type="text" id="lop" name="lop" class="form-control" value="{{ $say->lop }}">
                            </div>
                            <div class="form-group">
                                <label for="noi_dung">Nội dung nhận xét</label> <span class="text-danger">*</span>
                                <textarea name="noi_dung" class="form-control" id="noi_dung" cols="30" rows="10">{{ $say->noi_dung }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <img src="{{ asset('/says/' . $say->image) }}" height="150px" width="150px" alt="">
                            </div>
                        </div>
